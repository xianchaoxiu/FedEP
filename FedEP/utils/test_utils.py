...
def nsl_kdd_test(V_k, threshold=0.00025):
  ...
  precision_score, recall_score, accuracy_score, f1_score, fpr, fng =  results_analysis(df_gt_score, threshold=threshold, log=1)

  return accuracy_score

# Test on UNSW NB15
def unsw_nb15_test(V_k, threshold=0.000006):
  # Read data from csv files
...
# Test on IoT23
def iot23_test(V_k, threshold=1e-13):
  # Read data from csv files
...
# Test on ToN IoT
def ton_test(V_k, threshold=4e-8):
  # Read data from csv files
